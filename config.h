...
static const int sidepad	    = 100;
static const char *fonts[]          = { "JetBrainsMono:Regular:size=10", "Material Design Icons:Regular:pixelsize=16:antialias:true", "hack:size=10", "fontawesome:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"};
...
static const char col_light_black[] = "#000000";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_light_black,  col_dark_blue  },
};
...
static const char *const autostart[] = {
	"slstatus", NULL,
	"picom", "--corner-radius", "7", "--round-borders", "6", NULL,
	"redshift", NULL, "feh", "--bg-scale", "/home/cred/Pictures/a.jpeg", NULL,
	"/usr/lib/notify-osd/notify-osd", NULL,
	"xss-lock", "/home/cred/.local/scripts/lock.sh", NULL,
	NULL /* terminate */
};
...
static const char *lower_volume[] = {"pamixer", "-d", "10", NULL};
...
static Key keys[] = {
	...
	{ XK_NO_MOD,			XF86XK_AudioLowerVolume, spawn,	{.v = lower_volume} },
	{ XK_NO_MOD,			XF86XK_AudioRaiseVolume, spawn,	{.v = raise_volume} },
	{ XK_NO_MOD,			XF86XK_AudioMute, spawn,	{.v= mute_volume} },
